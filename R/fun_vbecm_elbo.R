...
#
# Internal functions gathering the ELBO terms for the core VBECM algorithms
...
get_elbo_gmss_vbecm <- function(Omega,
                                m_delta,
                                alpha_tau,
                                beta_tau,
                                m_tau,
...
get_elbo_gmn_vbecm <- function(Omega,
                               m_delta,
                               alpha_tau,
                               beta_tau,
                               m_tau,
...
get_elbo_gm_vbecm_v1 <- function(Omega,
                                 m_delta,
                                 alpha_tau,
                                 beta_tau,
                                 m_tau,
...
get_elbo_gm_vbecm_v2 <- function(Omega,
                                 m_delta,
                                 alpha_tau,
                                 beta_tau,
                                 m_tau,
