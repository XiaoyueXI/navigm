...
plot_roc(gmss_vbem$estimates$m_delta[upper.tri(net$A)], net$A[upper.tri(net$A)],main = 'edge selection')
  

plot_roc(gmss_vbem$estimates$m_gamma, beta_true_gmss!=0,main = 'variable selection')
...
These two outputs are subject to the threshold choices. The threshold is specified to 0.5 in this example. Alternatively, a [false discovery rate derived threshold](https://pubmed.ncbi.nlm.nih.gov/15054023/) may be employed.   
